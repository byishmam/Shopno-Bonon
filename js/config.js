...
window.SITE = {
  ...
  contact: {
    email: "shopnobonon.org@gmail.com",      /* EDIT: real address — it is used in a mailto: link */
    phone: "+880 1XXX-XXXXXX",               /* EDIT: real number, or set to "" to hide it */
  ...
  social: {
    ...
    x:         "#",
    email:     "mailto:shopnobonon.org@gmail.com"
  },
