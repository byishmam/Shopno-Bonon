...
window.TEAM = [
  {
    ...
    role: { bn: "প্রতিষ্ঠাতা ও সম্পাদক", en: "Founder & Editor" },
    photo: "assets/images/avatar-1.png",
    bio: {
      bn: "স্বপ্নবুনন-এর সম্পাদকীয় দিক দেখেন এবং বিতর্ক সেশন পরিচালনা করেন।",
      en: "Leads the editorial direction of Shopno Bonon and runs the debate sessions."
    },
    quote: { bn: "প্রতিটি শিক্ষার্থীর একটি কথা আছে, শুধু মঞ্চটা দরকার।", en: "Every student has something to say. What is missing is the stage." },
...
window.ARTICLES = [
  {
    ...
    author: "nusrat",
    title: {
      bn: "মঞ্চে ওঠার আগে যে ভয়টা হয়, সেটা আসলে কী",
      en: "What the fear before the stage is actually made of"
    },
    excerpt: {
      bn: "মঞ্চভীতি সাহসের অভাব নয়। এটি প্রস্তুতির একটি ধাপ—এবং এটিকে কাজে লাগানো যায়।",
      en: "Stage fright is not a shortage of courage. It is a stage of preparation, and it can be put to work."
    },
    body: {
      bn: `<p>প্রথম মঞ্চের কথা প্রায় সবাই একইভাবে বলে: হাত ঠান্ডা, গলা শুকনো, আর মনে হয় সবাই শুধু ভুলটাই খুঁজছে। এই অনুভূতিকে আমরা ভয় বলি, কিন্তু শরীর আসলে বলছে—"এখন গুরুত্বপূর্ণ কিছু ঘটছে, প্রস্তুত হও।"</p>
<h2>ভয় কমানো নয়, ব্যবহার করা</h2>
<p>ভয় পুরোপুরি চলে যাওয়ার অপেক্ষা করলে মঞ্চে ওঠা হবে না। অভিজ্ঞ বক্তারাও নার্ভাস হন; পার্থক্য হলো তাঁরা জানেন এই শক্তিটা কোথায় খরচ করতে হয়।</p>
<blockquote>যে উত্তেজনা আপনাকে কাঁপাচ্ছে, সেটাই আপনাকে সতর্ক রাখছে।</blockquote>
<h2>তিনটি কাজ, যা সত্যিই কাজে দেয়</h2>
<ul>
<li><strong>প্রথম ৩০ সেকেন্ড মুখস্থ রাখুন।</strong> শুরুটা নিয়ে ভাবতে না হলে বাকিটা অনেক সহজ হয়ে যায়।</li>
<li><strong>শ্রোতার দিকে তাকান, দেয়ালে নয়।</strong> তিনজন মানুষ বেছে নিন—বাঁয়ে, মাঝে, ডানে।</li>
<li><strong>থামতে শিখুন।</strong> নীরবতা দুর্বলতা নয়; এটি বাক্যকে জায়গা দেয়।</li>
</ul>
<p>বক্তৃতা ভালো হয় অনুশীলনে, অনুপ্রেরণায় নয়। সপ্তাহে তিনবার পাঁচ মিনিট—ফোনে রেকর্ড করে শুনুন। প্রথম সপ্তাহে অস্বস্তি লাগবে, তৃতীয় সপ্তাহে নিজের কণ্ঠ চিনতে শুরু করবেন।</p>`,
      en: `<p>Almost everyone describes a first stage the same way: cold hands, a dry throat, and the feeling that the room is only watching for a mistake. We call it fear, but the body is saying something simpler — something that matters is happening, get ready.</p>
<h2>Don't remove the nerves, spend them</h2>
<p>If you wait for the fear to disappear, you will never go up. Experienced speakers are nervous too. The difference is that they know where to spend that energy.</p>
<blockquote>The same tension that shakes your hands is what keeps you alert.</blockquote>
<h2>Three things that actually help</h2>
<ul>
<li><strong>Memorise the first thirty seconds.</strong> When the opening needs no thought, the rest gets easier.</li>
<li><strong>Look at people, not at the back wall.</strong> Choose three faces: left, centre, right.</li>
<li><strong>Learn to pause.</strong> Silence is not weakness. It gives a sentence room to land.</li>
</ul>
<p>Speaking improves with repetition, not with motivation. Five minutes, three times a week, recorded on your phone. The first week is uncomfortable. By the third you start recognising your own voice.</p>`
    }
  },
  {
