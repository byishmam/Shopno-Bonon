...
/*
   ...
   4. The home page's big "featured" spot is automatic: it always shows
      whichever article has the newest date, so a new article placed at
      the top with today's date will appear there on its own. The
      featured: true field is no longer used for this, but is left on
      existing entries and can be ignored.
