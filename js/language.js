...
(function () {
  ...
  const UI = {
    ...
    /* Share menu (article.html) */
    share:          { bn: "শেয়ার করুন",            en: "Share" },
    shareFacebook:  { bn: "ফেসবুকে শেয়ার করুন",     en: "Share on Facebook" },
    shareX:         { bn: "এক্স-এ শেয়ার করুন",       en: "Share on X" },
    shareWhatsapp:  { bn: "হোয়াটসঅ্যাপে শেয়ার করুন", en: "Share on WhatsApp" },
    shareLinkedin:  { bn: "লিংকডইনে শেয়ার করুন",     en: "Share on LinkedIn" },
    shareTelegram:  { bn: "টেলিগ্রামে শেয়ার করুন",    en: "Share on Telegram" },
    shareEmail:     { bn: "ইমেইলে শেয়ার করুন",       en: "Share by email" },
    shareMore:      { bn: "আরও অপশন",              en: "More options" },
